...
public class Pizza {
	...
	private Map<Topping, Boolean> ToppingsUsed;
	private boolean[] isToppingDoubled;// each index in this array will represent whether the topping at
										// Toppings.get(index) is doubled.
	...
	public Pizza(int pizzaID, String size, String crustType, int orderID, String pizzaState, String pizzaDate,
		...
		isToppingDoubled = new boolean[17];// We have 17 toppings, the array needs to be size 17. A good programmer
											// wouldn't hard code this.
		Discounts = new ArrayList<Discount>();

		ToppingsUsed = new HashMap<Topping, Boolean>();
	}
	...
	public Map<Topping, Boolean> getToppingsUsed() {
		return ToppingsUsed;
	}
	...
	public String toString() {
		return "PizzaID=" + PizzaID + " | CrustType= " + CrustType + ", Size= " + Size + " | For order " + OrderID
				+ " | Pizza Status: " + PizzaState + ", as of " + PizzaDate + " | Customer Price= " + CustPrice
				+ " | Business Price= "
				+ BusPrice;
	}
